...
while True: #cria um loop quando a tela e capturada
    ...
    if results.multi_hand_landmarks: #identifica quantas mãos estão levantadas
        for hand_landmarks in results.multi_hand_landmarks: #para cada mão levatada
            ...
            if dedos_levantados == 2:#Executa ações conforme o número de dedos
                cv2.putText(frame, "2 = office", (10, 100),cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
                ...
                cv2.putText(frame, "3 = Firefox", (10, 100),cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
                os.system("start chrome.exe")
                print("Firefox aberto")
                time.sleep(5.0)
                os.system("taskkill /F /IM chrome.exe")

            elif dedos_levantados == 4:
                cv2.putText(frame, "4 = Media Player", (10, 100),cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
                os.system("start wmplayer.exe")
                print("Media Player aberto")
                time.sleep(5.0)
